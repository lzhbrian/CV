...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  \color{blue}\textbf{\href{http://www.lzhbrian.me/}{\Large Tzu-Heng Lin (Brian) \small Maker, Hacker}} & 
...
%\section{\colorbox[rgb]{0.8,0.8,0.8}{\makebox(70,10){Education}}}
  ...
  \resumeSubHeadingListStart
    \resumeSubheadingedu
      ...
      {Bachelor of Business Administration in Management (Dual Major);  GPA: 90/100}
...
\sectionwithbox{Selected Honors}
  \resumeSubHeadingListStart
    \resumeSubheadinghonorone
      {Maker Representative}{, Tsinghua Universtiy \color{blue}\href{http://www.lzhbrian.me/posts_figure/maker.jpeg}{\textbf{[picture]}}}
