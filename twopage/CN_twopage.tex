...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  ...
  %\small~~~~
  出生于 \textbf{台湾}, 长大于 \textbf{上海}, 目前在 \textbf{北京}学习 & 邮箱 : \href{mailto:lzhbrian@gmail.com}{lzhbrian@gmail.com}\\
  
   清华大学电子工程系~本科三年级~(2018 年毕业) & 手机 : +86-131-2192-9165 \\
...
\sectionwithbox{技能}
  \resumeSubHeadingListStart
    \item{
      ...
      \hfill
      \textbf{工具}{: Git, Hadoop, CUDA, Qt, Weka, MySQL}
    \vspace{-7pt}
    }
  \resumeSubHeadingListEnd
  \resumeSubHeadingListStart
...
\sectionwithbox{经验~与~项目}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      {Owlii~\color{blue}\href{http://www.owlii.com}{[网站]}}{中国~北京}
      {\textbf{软件工程实习生}}{2017.3 - Present (3 mo)}
      \resumeItemListStart
        \resumeItem{CUDA GPU 编程}\\
        \vspace{1mm}
          {- 使用~CUDA 实现及加速算法}\\
      \resumeItemListEnd
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \vspace{1mm}
          {- 带领~2016~清华大学队式程序设计大赛~网站组, 协同工作, 使用~\emph{Git}~进行版本控制. }\\
    ...
    \resumeSubheading
      ...
      {\textbf{副会长}, 2 年创客领域经验}{2015.9 - 2017.2 (1.5 yrs)}
      \resumeItemListStart
        ...
        \vspace{1mm}
          ...
          {- 带领~\underline{\emph{项目部}}, \underline{\emph{外联部}}, \underline{\emph{常务部}} 工作，负责每周举办的创意周末以及创客比赛}\\
