...
\sectionwithbox{Work Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
	 \resumeItem{Published/Accepted: AAAI ICWSM, IEEE Globecom}\\
	 \resumeItem{Submitted: ACM CoNEXT, ACM CIKM, IEEE TNSM}\\
...
\sectionwithbox{Student Associations}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      {Beijing, China}
      {\textbf{Vice Leader of Dept.of Web \& Publicity}, also Web Dev Lead}{Jul 2015 - May 2016 (9 mo)}
...
\sectionwithbox{Selected Prizes \& Honors}
  \resumeSubHeadingListStart
      ...
      {Invited Reviewer}{, IEEE TNSM (IEEE Transactions on Network and Service Management)}
    ...
    \resumeSubheadinghonorone
      {Championship (1st/15 teams), Tsinghua Make-a-thon 2016}{, Tsinghua Universtiy}

    \resumeSubheadinghonorone
      {Championship (1st/15 teams), Tsinghua Make-a-thon 2015}{, Tsinghua Universtiy}
...
\sectionwithbox{Scholarships}
  ...
  \resumeSubHeadingListStart
     \resumeSubheadinghonor
      {1st(2015), 2nd(2016) Prize Scholarship for Taiwanese Student}{, Minister of Education, P.R.C.}
     ...
     \resumeSubheadinghonortwo
      {Excellence Scholarship(Zheng Geru) for Comprehensive Performance(2016)}{, Tsinghua University}
      {\underline{Top 35/260}, for students who have \underline{achieved \textbf{multiple individual scholarships}}.}
