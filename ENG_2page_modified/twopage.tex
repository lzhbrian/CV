...
\sectionwithbox{Technology Skills}
  \resumeSubHeadingListStart
    \item{
      ...
      \hfill
      \textbf{Tools}{: Git, Hadoop, CUDA, Weka, MySQL, Tableau}
    }
    \vspace{-7pt}
  \resumeSubHeadingListEnd
  ...
  \resumeSubHeadingListStart
    \item{
      \textbf{Experienced in}{: Big Data Analytics, Software Engineering, Playing around new Tools and Toys, Leadership}
    }
    \vspace{-5pt}
  \resumeSubHeadingListEnd
...
\sectionwithbox{Experience \& Projects}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      {\textbf{Vice President}, 2 years experience in maker field}{Sep 2015 - Feb 2017 (1.5 yrs)}
      \resumeItemListStart
        ...
        \resumeItemListStart
          ...
          \vspace{1mm}
            ...
            {~~~- \emph{iOS app development} using \emph{Swift} with \emph{Xcode}.} \\
              {~~~~~~- Built features include \emph{TableView}, \emph{SideMenu}, \emph{Customized Tab Button}, \emph{Customized Segue Effect}, \emph{QRCode}.} \\
